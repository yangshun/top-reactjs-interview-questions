...
* [了解虚拟 DOM](https://reactjs.org/docs/faq-internals.html#what-is-the-virtual-dom)
* [React 的差异算法](https://reactjs.org/docs/reconciliation.html#the-diffing-algorithm)
