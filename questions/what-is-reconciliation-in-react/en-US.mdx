...
- [Understanding the virtual DOM](https://reactjs.org/docs/faq-internals.html#what-is-the-virtual-dom)
- [React's diffing algorithm](https://reactjs.org/docs/reconciliation.html#the-diffing-algorithm)
