...
* [React 关于键的文档](https://react.dev/learn/rendering-lists#why-does-react-need-keys)
* [为什么键在 React 中很重要](https://medium.com/@robinpokorny/index-as-a-key-is-an-anti-pattern-e0349aece318)
* [React 中如何保留与重置 state](https://react.dev/learn/preserving-and-resetting-state)
