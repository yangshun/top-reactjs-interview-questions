...
* [React 关于 `useReducer` 的文档](https://reactjs.org/docs/hooks-reference.html#usereducer)
* [使用 `useReducer` hook](https://reactjs.org/docs/hooks-faq.html#how-to-avoid-passing-callbacks-down)
