...
* [React 文档：使用 Effect Hook](https://react.dev/reference/react/useEffect)
* [React 文档：Hook 的规则](https://react.dev/reference/rules/rules-of-hooks)
* [Overreacted：useEffect 的完整指南](https://overreacted.io/a-complete-guide-to-useeffect/)
