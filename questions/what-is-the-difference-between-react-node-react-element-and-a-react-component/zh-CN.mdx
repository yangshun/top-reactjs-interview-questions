...
*   [React 文档：渲染元素](https://reactjs.org/docs/rendering-elements.html)
*   [React 文档：组件和 props](https://reactjs.org/docs/components-and-props.html)
*   [React 文档：深入了解 JSX](https://reactjs.org/docs/jsx-in-depth.html)
