...
* [React 关于 `useCallback` 的文档](https://react.dev/reference/react/useCallback)
* [React 记忆化技术](https://react.dev/reference/react/memo#skipping-re-rendering-when-props-are-unchanged)
* [理解 React 的 `useCallback` 和 `useMemo`](https://kentcdodds.com/blog/usememo-and-usecallback)
